...
- **Claude-first, integration-ready.** Built in Python on the Claude Agent SDK; external tools (email, GitHub, Linear, …) connect through MCP.
...
- [`wayfinder/`](wayfinder/) — the decision map: every architectural decision, tracked as tickets.
- [`research/`](research/) — research notes backing those decisions.
